...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=localhost:5433;Database=postgres;Username=crud_user;Password=crud_password");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Attribute>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.AttributeCreatedByNavigations)
                .HasForeignKey(d => d.CreatedBy)
                .HasConstraintName("attributes_created_by_fkey");

            entity.HasOne(d => d.UpdatedByNavigation).WithMany(p => p.AttributeUpdatedByNavigations)
        ...
        modelBuilder.Entity<Coupon>(entity =>
        {
            ...
            entity.HasOne(d => d.UpdatedByNavigation).WithMany(p => p.CouponUpdatedByNavigations)
                .HasForeignKey(d => d.UpdatedBy)
        ...
        modelBuilder.Entity<GalleryPart1>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ProductId, e.IsThumbnail }, "gallery_part1_product_id_is_thumbnail_idx");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.GalleryPart1s)
                .HasForeignKey(d => d.ProductId)
        ...
        modelBuilder.Entity<GalleryPart2>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ProductId, e.IsThumbnail }, "gallery_part2_product_id_is_thumbnail_idx");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.GalleryPart2s)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("gallery_product_id_fkey");
        });
        ...
        modelBuilder.Entity<GalleryPart3>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ProductId, e.IsThumbnail }, "gallery_part3_product_id_is_thumbnail_idx");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.GalleryPart3s)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("gallery_product_id_fkey");
        });
        ...
        modelBuilder.Entity<Notification>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("now()")
                .HasColumnName("created_at");
            entity.Property(e => e.NotificationExpiryDate).HasColumnName("notification_expiry_date");
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.Property(e => e.OrderDeliveredCarrierDate).HasColumnName("order_delivered_carrier_date");
            entity.Property(e => e.OrderDeliveredCustomerDate).HasColumnName("order_delivered_customer_date");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(e => e.ComparePrice)
                .HasDefaultValue(0m)
            ...
            entity.Property(e => e.CreatedAt)
                ...
                .HasColumnName("created_at");
            entity.Property(e => e.CreatedBy).HasColumnName("created_by");
            entity.Property(e => e.DisableOutOfStock)
                .HasDefaultValue(true)
        ...
        modelBuilder.Entity<ProductAttributeValue>(entity =>
        {
            ...
            entity.HasIndex(e => e.AttributeValueId, "idx_product_attribute_values_attribute_value_id");

            entity.HasIndex(e => e.ProductAttributeId, "idx_product_attribute_values_product_attribute_id");
        ...
        modelBuilder.Entity<ProductCoupon>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ProductId, e.CouponId }, "idx_product_id_coupon_id_product_coupons");
            ...
            entity.HasOne(d => d.Coupon).WithMany(p => p.ProductCoupons)
                .HasForeignKey(d => d.CouponId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("product_coupons_coupon_id_fkey");

            entity.HasOne(d => d.Product).WithMany(p => p.ProductCoupons)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<ProductShippingInfo>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductShippingInfos)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.SetNull)
        ...
        modelBuilder.Entity<Sell>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithOne(p => p.Sell)
        ...
        modelBuilder.Entity<ShippingCountryZone>(entity =>
        {
            ...
            entity.HasOne(d => d.Country).WithMany(p => p.ShippingCountryZones)
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("shipping_country_zones_country_id_fkey");

            entity.HasOne(d => d.ShippingZone).WithMany(p => p.ShippingCountryZones)
        ...
        modelBuilder.Entity<ShippingZone>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.ShippingZoneCreatedByNavigations)
                .HasForeignKey(d => d.CreatedBy)
                .HasConstraintName("shipping_zones_created_by_fkey");

            entity.HasOne(d => d.UpdatedByNavigation).WithMany(p => p.ShippingZoneUpdatedByNavigations)
                .HasForeignKey(d => d.UpdatedBy)
        ...
        modelBuilder.Entity<Slideshow>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                .HasDefaultValueSql("uuid_generate_v4()")
                .HasColumnName("id");
            entity.Property(e => e.BtnLabel)
                .HasMaxLength(50)
                .HasColumnName("btn_label");
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.SlideshowCreatedByNavigations)
                .HasForeignKey(d => d.CreatedBy)
                .HasConstraintName("slideshows_created_by_fkey");

            entity.HasOne(d => d.UpdatedByNavigation).WithMany(p => p.SlideshowUpdatedByNavigations)
                .HasForeignKey(d => d.UpdatedBy)
        ...
        modelBuilder.Entity<Variant>(entity =>
        {
            ...
            entity.HasOne(d => d.VariantOptionNavigation).WithMany(p => p.Variants)
        ...
        modelBuilder.Entity<VariantOption>(entity =>
        {
            ...
            entity.HasOne(d => d.Image).WithMany(p => p.VariantOptions)
                .HasForeignKey(d => d.ImageId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("variant_options_image_id_fkey_1");

            entity.HasOne(d => d.ImageNavigation).WithMany(p => p.VariantOptions)
                .HasForeignKey(d => d.ImageId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("variant_options_image_id_fkey_2");

            entity.HasOne(d => d.Image1).WithMany(p => p.VariantOptions)
                .HasForeignKey(d => d.ImageId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("variant_options_image_id_fkey_3");

            entity.HasOne(d => d.Product).WithMany(p => p.VariantOptions)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<VariantValue>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductAttributeValueId, "idx_product_attribute_value_id_variant_values");
            ...
            entity.HasOne(d => d.ProductAttributeValue).WithMany(p => p.VariantValues)
